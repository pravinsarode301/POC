        ...
        setupFormValidation: function()
        {
            ...
            $("#per_day_report-form").validate({
                rules: {
                	...
                	from_month_report_date:{ required: true },
                	to_month_report_date:{ required: true }
                ...
                messages: {
                	...
                	from_month_report_date:  "<font color=red>Please select start month to generate report</font>",
                	to_month_report_date: "<font color=red>Please select end month generate report</font>"
		...
		<div class="col-md-11" style="margin-left: 30px">
			<div class="panel panel-default" style="margin-top: 20px;">
				<div class="panel-heading">
					<span class="glyphicon glyphicon-pencil"></span>Month Report
				</div>
				<div class="panel-body">
					...
					<form  class="form-horizontal" action="Controller" method="post" name="per_day_report-form" id="per_day_report-form" novalidate="novalidate">
						...
						<input type="hidden" name="monthlyReportFormDetails"	value="monthlyReportFormDetails">
						<fieldset>
							<!-- Date & Time--->
							<div class="form-group">
								<label class="col-md-3 control-label" for="name">From Month </label>
								<div class="col-md-9">
									<input name="from_month_report_date" type="month" value="" class="form-control"/>
								</div>
							</div>

						<!-- Date & Time--->
							<div class="form-group">
								<label class="col-md-3 control-label" for="name">To Months </label>
								<div class="col-md-9">
								
									<input name="to_month_report_date" type="month" value="" class="form-control"/>
								</div>
							</div>
...
<div class="row">
			<div class="col-md-11" style="margin-left:30px ; ">
				<div class="panel panel-default">
					<div class="panel-heading"> Monthly Order Report</div>
