...
<div class="container-fluid">
	<div class="container">
		...
		<div class="col-md-9">
			...
			<h4>
				...
				Profile Details<span><a href="ProfileView.html">
				<form class="form-horizontal" action="EditFarmerProfile"	method="post" >
				<%
 ...
 --%>							<%-- <img src="data:image/jpg;base64, <%=b64 %>" alt="Visruth.jpg not found" /> --%>
						<button value="Submit" name="submit"
							...
							style="margin-top: -11px; margin-right: 4px; width: 68px; height: 33px;">Edit</button>
				</a></span>
			</h4>
			<div class="panel panel-default">
				<div class="panel-body">
						...
						<fieldset>
							<div class="row">
								<div class="col-md-4">
									<img src="data:image/jpg;base64,<%=ImageLoaderUtility.imageHtmlLoader(rt.getString("profile_pic_path"))%>" class="img-responsive" />
								</div>
								<div class="col-md-8">
								...
								<div class="form-group">
									<div class="col-md-12">
										<button type="submit"
											...
											value="Submit" style="margin-left: 10px; margin-right: 15px;">Submit</button>
