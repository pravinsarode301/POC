						...
						<div class="panel panel-default">
							<form action="RelevantCompaniesForProduct" method="post">
								<div class="panel-body info">
									...
									<p>
										<b><%=rt.getString("subProductName")%></b>
									</p>
									<p>
										Product Family:<%=rt.getString("mainProductName")%></p>
									<p>
										Added Date :<%=rt.getDate("addedDate")%></p>
									<p>Mumbai</p>

									<br />
									<center>
										<input type="hidden" name="subProductName"
											value="<%=rt.getString("subProductName")%>"> <input
											type="hidden" name="subProductId"
											value="<%=rt.getString("subProductId")%>">
										<button type="submit" class="btn btn-success" name="readMore">Read
											More</button>
									</center>
								</div>
							</form>
