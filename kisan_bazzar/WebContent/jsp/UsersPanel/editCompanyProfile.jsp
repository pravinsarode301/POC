...
<%
	String JspPagePathHeader1 = getServletContext().getInitParameter("UsersResources");
%>
		...
		<div class="row">
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						...
						if(request.getAttribute("updatefail")!=null){
							out.print(request.getAttribute("updatefail"));
			...
			<div class="col-md-9">
				...
				<div class="panel panel-default">
					...
					System.out.println("issue in EditCompanyProfile");
					ResultSet rt = (ResultSet)request.getAttribute("rt");
					
					while(rt.next()){
					%>

						<form class="form-horizontal" action="UpdateCompanyProfile"
							method="post" enctype="multipart/form-data">

							<!-- <fieldset> -->
							<input type="hidden" name="companyId" value="<%=rt.getInt(1)%>">
							<input type="hidden" name="status" value="comSpecsData">
							<!-- new added data -->
							<div class="row">
								<div class="col-md-4">
									<!-- jsp/UsersPanel/ -->
									
									<img src="data:image/jpg;base64,<%=ImageLoaderUtility.imageHtmlLoader(rt.getString("profile_pic")) %>" class="img-responsive" /> <br />
									<br /> upload file:<input type="file" class="btn btn-success btn-md"
													name="profilePicPath"
									...
									<%-- <input name="profilePic" type="file"  class="btn btn-success btn-md" value="<%=rt.getString("profile_pic") %>">
									<%= rt.getString("profile_pic") %> --%>
								</div>
								...
								<div class="col-md-8">
									...
									<div class="row margin-inp">
										...
										<div class="col-md-8">
											<input value="<%=rt.getString("company_registred_id")%>"
												...
												placeholder="Enter company Registered Id"
												class="form-control">
										</div>
									</div>
									<br>
									<div class="row margin-inp">
										<div class="col-md-4">
											<label class="control-label" for="name">Authorised
												person Name</label>
										</div>
										<div class="col-md-8">
									...
									<div class="row margin-inp">
										...
										<div class="col-md-8">
											<input
												...
												name="authorisedPersonMobileNumber" type="tel"
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<input value="<%=rt.getString("company_email_id") %>"
										...
										placeholder="Enter Company Email-Id" class="form-control">
								</div>
								...
								<label class="col-md-2 control-label" for="Country">Contact
									Number</label>
								<div class="col-md-4">
									<input value="<%=rt.getInt("company_contact_number") %>"
							...
							<div class="form-group">
								<label class="col-md-2 control-label" for="Mobile">Fax
									number</label>
								<div class="col-md-4">
									<input value="<%=rt.getInt("company_fax_number") %>"
								...
								<div class="col-md-4">
									<input value="<%=rt.getString("landmark") %>"
										name="companyLandmark" type="text"
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<input value="<%=rt.getString("city") %>" name="companyCity"
								...
								<div class="col-md-4">
									<input value="<%=rt.getString("state") %>" name="companyState"
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<input value="<%=rt.getString("country") %>"
										name="companyCountry" type="text" placeholder="Enter Country"
										class="form-control">
								</div>
								...
								<div class="col-md-4">
									<input value="<%=rt.getString("registration_date")%>"
										...
										placeholder="Enter Registration Date" class="form-control">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<label class="col-md-2 control-label" for="companyCreator">Current
									Address</label>
								<div class="col-md-4">
									<input value="<%=rt.getString("company_current_address") %>"
										name="companyCurrentAddress" type="text"
										placeholder="Enter Address" class="form-control">
								</div>
								<label class="col-md-2 control-label" for="companyCreator">Register
									Address</label>
								<div class="col-md-4">
									<input value="<%=rt.getString("company_register_address") %>"
										name="companyRegisterAddress" type="text"
										placeholder="Enter Address" class="form-control">
								</div>
							...
							<div class="form-group">
								<label class="col-md-2 control-label" for="companyCreator">Pin
									Code</label>
								<div class="col-md-4">
									<input value="<%=rt.getString("pin_code") %>" name="pinCode"
										type="text" placeholder="Enter Address" class="form-control">
								</div>

								<%-- 	<label class="col-md-2 control-label" for="companyCreator">Change profile Pic</label>
									<div class="col-md-4">
										<input value="<%=rt.getString("profile_pic") %>" name="profilePic" type="file"
											 class="form-control" >
									</div>
								 --%>
							</div>
							...
							<div class="form-group">
								...
								<div class="form-group">
									<div class="col-md-12">
										...
										<a href="<%=JspPagePathHeader1 %>CompanyProfile.jsp"
											class="btn btn-info btn-md pull-right" name="Reset"
											value="Submit" style="margin-left: 10px; margin-right: 15px;">Cancle</a>
