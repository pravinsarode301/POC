...
<div class="container-fluid">
	<div class="container">
		...
		<div class="col-md-9">
			<br>
			<h4>
				<b>Profile Details</b><span><a href="ProfileView.html"><button
							value="Submit" name="submit"
							class="btn btn-success btn-md pull-right" type="submit"
							style="margin-top: -11px; margin-right: 4px; width: 68px; height: 33px;">Edit</button></a></span>
			</h4>
				...
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<form class="form-horizontal" action="UpdateFarmerData"	method="post">
							<input type="hidden" name="farmerId" value="<%=rt.getInt("farmer_id")%>"> 
							...
							<fieldset>
								...
								<div class="form-group">
									...
									<label class="col-md-2 control-label" for="email"> Last
										Name:</label>
									<div class="col-md-4">
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<input value="<%=rt.getString("email_id")%>"
											name="farmerEmailid" type="text" placeholder="Enter E-mail"
											class="form-control">
									</div>



									<label class="col-md-2 control-label" for="Mobile">Contact
										no.:</label>
									<div class="col-md-4">
								...
								<div class="form-group">
									<label class="col-md-2 control-label" for="Mobile">Date
										Of Birth:</label>
									<div class="col-md-4">
									...
									<label class="col-md-2 control-label" for="Mobile">Gender:</label>
									<div class="col-md-4">
										<input value="<%=rt.getString("gender")%>"
											name="farmnerGender" type="text" placeholder="Enter Gender"
											class="form-control">
									</div>
								</div>

								<div class="form-group">
									<label class="col-md-2 control-label" for="Mobile">Address:</label>
									<div class="col-md-4">
										<input value="<%=rt.getString("address")%>"
											name="farmerAddress" type="text" placeholder="Enter Address"
											class="form-control">
									</div>
									...
									<div class="col-md-4">
										<input value="<%=rt.getString("country")%>"
											name="farmerCountry" type="text" placeholder="Enter Country"
											class="form-control">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<input value="<%=rt.getString("state")%>" name="farmerState"
									...
									<div class="col-md-4">
										<input value="<%=rt.getString("district")%>"
											name="farmerDistrict" type="text" placeholder="Enter City"
											class="form-control">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<input value="<%=rt.getString("pin_code")%>"
											name="farmerPincode" type="text" placeholder="Enter Pin code"
											class="form-control">
									</div>



									<label class="col-md-2 control-label" for="Mobile">Fiels
										2:</label>
									<div class="col-md-4">
										<input value=" " name="companyRegistrationDate" type="date"
									...
									<div class="form-group">
										<div class="col-md-12">
											...
											<button type="Reset" class="btn btn-danger btn-md pull-right"
												name="Reset" value="Submit">Cancle</button>
