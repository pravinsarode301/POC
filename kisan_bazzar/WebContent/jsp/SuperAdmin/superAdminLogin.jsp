...
<body>
	...
	<div class="row">
		<div
			...
			<div class="login-panel panel panel-default panel-col-sm-8">
				...
				<%
						if (request.getAttribute("loginErrorStatus") != null) {
					%>
					<div class="panel-body">
						<div class="alert alert-success alert-dismissible" role="alert">
							...
							<strong> <%=request.getAttribute("loginErrorStatus")%></strong>
						</div>
						<%
							}
						%>
						<%
							if (request.getAttribute("directAccessStatus") != null) {
						%>
						<div class="panel-body">
							<div class="alert alert-success alert-dismissible" role="alert">
								<button type="button" class="close" data-dismiss="alert"
								...
								<strong> <%=request.getAttribute("directAccessStatus")%></strong>
							</div>
							<%
								}
							%>
							...
							<div class="panel-body">
								<div class="alert alert-success alert-dismissible" role="alert">
									...
									<strong> <%=request.getAttribute("LogOffStatus")%></strong>
								</div>
								<%
									}
								%>
				
					<form role="form" action="adminLogin" method="post" name="register-form" id="register-form" novalidate="novalidate">
						<p></p>
						
						<input type="hidden" class="form-control" name="dataFromAdminPanel" value=""dataFromAdminPanel />
						<fieldset>
							...
							<a href="#" data-toggle="" data-target="">Forgot
									Password?</a>
								<!-- <a href="SuperAdmin?forgotPassword" data-toggle="" data-target="">Forgot
									Password?</a> -->
								<!-- 	<a href="#" data-toggle="modal" data-target="#pop">Forgot
									Password?</a> -->
							</div>
	...
	<div class="modal fade bs-example-modal-sm" id="pop" tabindex="-1"
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">Modal title</h4>
								...
								<%
									if (request.getAttribute("wrong_email_status") != null) {
								%><div class="panel-body">
								<div class="alert alert-success alert-dismissible" role="alert">
									<button type="button" class="close" data-dismiss="alert"
										aria-label="Close">
									...
									<script type="text/javascript">
										window.open(document.getElementById("pop"));
										var status = document.getElementById("pop");
										// document.body.innerHTML="";
									</script>
									<strong id="wrong_mail_status"> <%=request.getAttribute("wrong_email_status")%></strong>
								</div>	<%
										}
									%>
								...
								<form role="form" action="forgotpass_send_mail" method="post">
