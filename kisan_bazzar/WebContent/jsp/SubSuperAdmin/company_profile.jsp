		...
		<div class="row">
			<div class="col s12 m12 l12">
				<div class="card-panel">
									...
									<div class="row">
										<div class="input-field col s12 m12 l6">
											<input id="Company_Name" type="text" Name="Company_Name"
												value="<%=rt.getString("company_name")%>" disabled>
											<label for="Company_ID">Company Name</label>
										</div>

										<div class="input-field col s12 m12 l6">
											<input id="Company_Reg_ID" type="text" Name="Company_Reg_ID"
												value="<%=rt.getString("company_registred_id")%>" disabled>
									...
									<div class="row">
										<div class="input-field col s12 m12 l6">
											<input id="Authorised_Person_Name" type="text"
												...
												Name="Authorised_Person_Name" disabled> <label
										...
										<div class="input-field col s12 m12 l6">
											<input id="Authorised_Person_Mobile_Number" type="text"
												...
												Name="Authorised_Person_Mobile_Number" disabled> <label
							...
							<div class="row">
								...
								<div class="input-field col s12 m12 l6">
									<input id="Company_Fax_Number" type="text"
										...
										Name="Company_Fax_Number" disabled> <label
								...
								<div class="input-field col s12 m12 l6">
									<input id="Company_Landmark" type="text"
										...
										disabled> <label for="Company_Landmark">Company
										Landmark</label>
								</div>
							</div>
							<div class="row">
							...
							<div class="row">
								...
								<div class="input-field col s12 m12 l6">
									<input id="Company_Country" type="text" Name="Company_Country"
										value="<%=rt.getString("country")%>" disabled> <label
								...
								<div class="input-field col s12 m12 l6">
									<input type="date" class="datepicker" value="<%=hh%>"
										disabled> <label for="Registration_Date">Registration
										Date</label>
								</div>
							</div>
					</div>
					<!-- <div class="row">
                      <div class="input-field col s12 m12 l6">
                        <input id="Company_ID" type="text" Name="Company_ID" value="" disabled>
